  ...
  render() {
    return (
      <div>
        ...
        <DocumentEditorContainerComponent id="container"  height={'590px'} serviceUrl={"http://localhost:6002/api/documenteditor/"} enableToolbar={true} enableSpellCheck={true} created={this.onCreated.bind(this)} />
      </div>
    );
  }
}